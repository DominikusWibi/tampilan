            ...
            <div class="col-md-12">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-sm btn-danger"  @click="deaktivasi()">DEAKTIVASI depo</button>
...
export default {
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get('http://127.0.0.1:8000/api/member/indexdepo').then(response => {
...
function deaktivasi() {
        axios.put('http://127.0.0.1:8000/api/member/resetdepo')
        .then(() => {
